...
y_count = 5
z_count = 5
y_line_width_in_indices = 2  # TODO: Try to make this thicker
z_line_width_in_indices = 2
...
boundary_mask[:, 0:y_line_width_in_indices+1, :] = True
boundary_mask[:, Y_SIZE-y_line_width_in_indices-1: Y_SIZE, :] = True
boundary_mask[:, :, 0:z_line_width_in_indices+1] = True
boundary_mask[:, :, Z_SIZE-z_line_width_in_indices-1:Z_SIZE] = True
